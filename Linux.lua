...
Linux.FrameTransparency = 0.65
Linux.FrameColor = Color3.fromRGB(55, 55, 57)
Linux.MainFrameColor = Color3.fromRGB(10, 10, 11)
...
function Linux.RegisterTransparencyElement(element, elementType)
    table.insert(Linux.TransparencyElements, {
        Element = element,
        Type = elementType
    })
end
...
function Linux.ApplyTransparency(enabled)
    ...
    for _, elementData in pairs(Linux.TransparencyElements) do
        ...
        if element and element.Parent then
            ...
            if elementType == "Main" then
                local tween = TweenService:Create(element, tweenInfo, {
                    BackgroundTransparency = enabled and 0.13 or 0
                })
            ...
            elseif elementType == "Frame" then
                local tween = TweenService:Create(element, tweenInfo, {
                    BackgroundTransparency = enabled and Linux.FrameTransparency or 0,
                    BackgroundColor3 = enabled and Linux.FrameColor or Color3.fromRGB(39, 39, 39)
                })
                globalConnectionManager:addTween(tween)
                tween:Play()
                
            elseif elementType == "TabBtn" then
                local tween = TweenService:Create(element, tweenInfo, {
                    BackgroundTransparency = enabled and 1 or 0,
                    BackgroundColor3 = enabled and Linux.FrameColor or Color3.fromRGB(39, 39, 39),
                    BorderSizePixel = enabled and 0 or 0
                })
                globalConnectionManager:addTween(tween)
                tween:Play()
            ...
            elseif elementType == "TextBox" then
                local tween = TweenService:Create(element, tweenInfo, {
                    BackgroundColor3 = enabled and Color3.fromRGB(30, 30, 32) or Color3.fromRGB(23, 23, 27)
                })
                globalConnectionManager:addTween(tween)
                tween:Play()
                ...
                if stroke then
                    local strokeTween = TweenService:Create(stroke, tweenInfo, {
                        Thickness = enabled and 1 or 0,
                        Color = enabled and Color3.fromRGB(30, 30, 30) or Color3.fromRGB(30, 30, 30)
                    })
                    globalConnectionManager:addTween(strokeTween)
                    strokeTween:Play()
                end
            end
        end
...
function Linux.LoadTransparencySettings()
    local success, result = pcall(function()
        if readfile and isfile(Linux.ConfigFolder .. "/transparency.json") then
            ...
            Linux.TransparencyEnabled = transparencyData.Enabled or true
            return true
        else
    ...
    local success, result = pcall(function()
        if listfiles and isfolder(Linux.ConfigFolder) then
            ...
            for _, file in pairs(files) do
                ...
                if configName and configName ~= "autoload" and configName ~= "privacy" and configName ~= "accent" and configName ~= "resize" and configName ~= "transparency" then
...
function Linux.Create(config)
    ...
    local Main = Linux.Instance("Frame", {
        ...
        BorderColor3 = Color3.fromRGB(39, 39, 42),
        BackgroundTransparency = Linux.TransparencyEnabled and 0.13 or 0,
        BorderSizePixel = 0,
    ...
    Linux.RegisterTransparencyElement(Main, "Main")
    ...
    local TopBar = Linux.Instance("Frame", {
        Parent = Main,
        BackgroundColor3 = Linux.MainFrameColor,
        BackgroundTransparency = Linux.TransparencyEnabled and 1 or 0,
        BorderColor3 = Color3.fromRGB(39, 39, 42),
        BorderSizePixel = 0,
    ...
    Linux.RegisterTransparencyElement(TopBar, "TopBar")
    ...
    function LinuxLib.Tab(config)
        ...
        local TabBtn = Linux.Instance("TextButton", {
            Parent = TabHolder,
            BackgroundColor3 = Linux.TransparencyEnabled and Linux.FrameColor or Color3.fromRGB(39, 39, 39),
            BackgroundTransparency = Linux.TransparencyEnabled and 1 or 0,
            BorderColor3 = Color3.fromRGB(39, 39, 42),
            BorderSizePixel = 0,
        ...
        Linux.RegisterTransparencyElement(TabBtn, "TabBtn")
        ...
        local function SelectTab()
            ...
            if CurrentTab and Tabs[CurrentTab] then
                ...
                oldTab.Button.BackgroundColor3 = Linux.TransparencyEnabled and Linux.FrameColor or Color3.fromRGB(39, 39, 39)
                oldTab.Button.BackgroundTransparency = Linux.TransparencyEnabled and 1 or 0
        ...
        function TabElements.Button(config)
            ...
            local BtnFrame = Linux.Instance("Frame", {
                ...
                BackgroundColor3 = Linux.TransparencyEnabled and Linux.FrameColor or Color3.fromRGB(39, 39, 39),
                BackgroundTransparency = Linux.TransparencyEnabled and Linux.FrameTransparency or 0,
                BorderColor3 = Color3.fromRGB(39, 39, 42),
                BorderSizePixel = 0,
            ...
            Linux.RegisterTransparencyElement(BtnFrame, "Frame")
            ...
            globalConnectionManager:addConnection(Btn.MouseLeave:Connect(function()
                local tween1 = TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundTransparency = Linux.TransparencyEnabled and Linux.FrameTransparency or 0})
                local tween2 = TweenService:Create(HoverEffect, TweenInfo.new(hoverDuration, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    Size = UDim2.new(0, 0, 1, 0),
                    BackgroundTransparency = 1
                })
        ...
        function TabElements.Toggle(config)
            ...
            Linux.RegisterTransparencyElement(Toggle, "Frame")
        ...
        function TabElements.Dropdown(config)
            ...
            Linux.RegisterTransparencyElement(Dropdown, "Frame")
        ...
        function TabElements.Slider(config)
            ...
            Linux.RegisterTransparencyElement(Slider, "Frame")
        ...
        function TabElements.Input(config)
            ...
            Linux.RegisterTransparencyElement(Input, "Frame")
            ...
            local TextBoxFrame = Linux.Instance("Frame", {
                Parent = Input,
                BackgroundColor3 = Linux.TransparencyEnabled and Color3.fromRGB(30, 30, 32) or Color3.fromRGB(23, 23, 27),
                BackgroundTransparency = 0.7,
                BorderSizePixel = 0,
            ...
            Linux.RegisterTransparencyElement(TextBoxFrame, "TextBox")
            ...
            Linux.Instance("UIStroke", {
                Parent = TextBoxFrame,
                Color = Color3.fromRGB(30, 30, 30),
                Thickness = Linux.TransparencyEnabled and 1 or 0,
        ...
        function TabElements.Label(config)
            ...
            Linux.RegisterTransparencyElement(LabelFrame, "Frame")
        ...
        function TabElements.Section(config)
            ...
            if config.Icon then
                local resolvedIcon = resolve Icon(config.Icon)
                if resolvedIcon then
                    SectionIcon = Linux.Instance("ImageLabel", {
                        Parent = Section,
                        BackgroundTransparency = 1,
        ...
        function TabElements.Paragraph(config)
            ...
            Linux.RegisterTransparencyElement(ParagraphFrame, "Frame")
        ...
        function TabElements.ColorPicker(config)
            ...
            Linux.RegisterTransparencyElement(ColorPicker, "Frame")
    ...
    if config.ConfigSave ~= false then
        ...
        local transparencyToggle = SettingsTab.Toggle({
            Name = "Transparency",
            Description = "Enable or disable interface transparency",
            Default = Linux.TransparencyEnabled,
            Callback = function(state)
                Linux.ApplyTransparency(state)
                Linux.SaveTransparencySettings()
            end
        })
